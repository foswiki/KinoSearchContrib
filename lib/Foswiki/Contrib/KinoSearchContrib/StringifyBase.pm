...
package Foswiki::Contrib::KinoSearchContrib::StringifyBase;
use strict;
use Module::Pluggable (require => 1, search_path => [qw/Foswiki::Contrib::KinoSearchContrib::StringifierPlugins/]);

__PACKAGE__->plugins;

use constant DEFAULT_HANDLER => "Foswiki::Contrib::KinoSearchContrib::StringifyPlugins::Text";
{
    my %mime_handlers;
