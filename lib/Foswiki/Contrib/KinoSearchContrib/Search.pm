...
sub search {
    ...
    my $searchAttachmentsOnly = $Foswiki::cfg{KinoSearchContrib}{SearchAttachmentsOnly} || 0;
	...
	my $attachmentsOnlyLabel = $Foswiki::cfg{KinoSearchContrib}{AttachmentsOnlyLabel} || "Show only attachments";
